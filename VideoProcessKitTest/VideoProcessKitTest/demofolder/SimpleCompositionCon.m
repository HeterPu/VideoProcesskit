...
- (void)viewDidLoad {
    ...
    NSString *output =  [path stringByAppendingPathComponent:@"output.m4a"];
...
//    VPKCompositonChannel *channel2 = [[VPKCompositonChannel alloc]initWithChannelId:0 mediaType:AVMediaTypeVideo range:CMTimeRangeMake(kCMTimeZero, kCMTimeZero) fileUrl:[NSURL fileURLWithPath:path2]];
      ...
      VPKCompositonChannel *channel3 = [[VPKCompositonChannel alloc]initWithChannelId:0 mediaType:AVMediaTypeVideo range:CMTimeRangeMake(kCMTimeZero, kCMTimeZero) fileUrl:[NSURL fileURLWithPath:path4]];
      ...
      VPKCompositonChannel *channel5 = [[VPKCompositonChannel alloc]initWithChannelId:0 mediaType:AVMediaTypeAudio range:CMTimeRangeMake(CMTimeMake(240, 1), CMTimeMake(30, 1)) fileUrl:[NSURL fileURLWithPath:path4]];
    
    
    _manager = [[VPKCompositonManager alloc]init];
    [_manager compositeWthVideoChannels:nil audioChannels:@[@[channel5,channel4]] outPutParh:output progressBlock:nil  successBlock:^(NSURL *fileUrl) {
